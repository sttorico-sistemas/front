<template>
  <div class="panel mt-6">
    ...
    >
      ...
      <div
        class="header_actions flex items-center gap-20"
      >
        <multiselect
          v-model="tipo_tabela"
          :options="['Tabela 1', 'Tabela 2']"
          class="custom-multiselect md:min-w-[400px]"
    ...
    >
      ...
      <label-input
        ...
        class-label="text-lg text-primary_3-table"
...
<script lang="ts" setup>
  ...
  const isOpenDialog = ref<boolean>(false)
	...
	const filtered = (value: string = '') => {
		...
		if (selected.type === 'tipo_tabela')
			return rows.filter((item: any) => item.tipo_tabela === value)
	}
</script>
