    ...
    >
      ...
      >
        <multiselect
          v-model="uf"
          :options="['SC', 'RJ']"
          class="custom-multiselect md:min-w-[80px]"
          placeholder="UF"
          :searchable="false"
          ...
          select-label=""
          deselect-label=""
          @select="(selected.label = $event), (selected.type = 'uf')"
        />
        <multiselect
          v-model="cidade"
          :options="['Balneário Camboriú', 'Rio de Janeiro']"
    ...
    >
      <div class="flex flex-col">
        ...
        <label-input
          ...
          label="UF"
          class-label="text-sm"
          class-input="md:max-w-[80px] mb-3"
          layout="row"
        />
      </div>
