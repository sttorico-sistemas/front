  ...
  <div class="panel">
    ...
    <div class="flex justify-center items-center gap-2 flex-wrap md:flex-nowrap">
      ...
      <label-input
        ...
        class-wrapper="w-full md:min-w-[300px]"
        layout="row"
        disabled
      />
      <label-input
      ...
      <label-input
        ...
        class-wrapper="w-full md:min-w-[50px]"
        layout="row"
        disabled
      />
    </div>
    <div class="flex justify-center items-center gap-2 flex-wrap md:flex-nowrap">
      <label-input
        ...
        class-wrapper="w-full md:max-w-[400px]"
        layout="row"
      />
      <label-input
        type="tel"
        ...
        label="Telefone"
        class-label="text-[10px]"
        class-input="md:max-w-[150px] mb-3"
        class-wrapper="w-full md:max-w-[150px]"
        layout="row"
      />
      <label-input
        type="cel"
