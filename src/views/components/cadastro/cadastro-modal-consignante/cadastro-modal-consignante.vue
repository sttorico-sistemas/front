...
<template>
    ...
    <div class="panel mt-5 border border-primary_3-table flex items-center md:gap-12">
      ...
      <div class="flex items-center gap-6">
        <select 
          ...
          class="form-select w-auto md:w-[500px] h-[38px] font-normal" 
          required
        >
    ...
    <div class="panel border mt-5 border-primary_3-table">
      ...
      <div class="flex flex-col md:flex-row items-center mb-3">
        ...
        <label for="tipo_entidade" class="mb-0 md:ml-3 md:mr-2 w-full md:w-auto text-sm text-left">Tipo de Entidade</label>
