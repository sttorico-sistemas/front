<script lang="ts" setup>
  ...
  import CadastrarMargem from '../modal-cadastrar-margem/modal-cadastrar-margem.vue'
	...
	<main>
        ...
        <div class="flex items-center gap-14">
					...
					<tippy target="right" placement="right"
						>Cadastre uma nova margem</tippy
					>
				</div>
        ...
        <div
				...
				>
					<multiselect
						v-model="grupoMargem"
						:options="['Margem Principal', 'Margem Secundária']"
						class="custom-multiselect min-w-[200px]"
						placeholder="Grupo Margem"
						:searchable="false"
