<script lang="ts" setup>
  ...
  import CadastrarNormativo from '../modal-cadastrar-normativo/modal-cadastrar-normativo.vue'
	...
	<main>
        ...
        <div class="flex items-center gap-14">
					...
					<tippy target="right" placement="right"
						>Cadastre um novo normativos</tippy
					>
				</div>
        ...
        <div
          ...
          <multiselect
            ...
            select-label=""
            deselect-label=""
            @select="(selected.label = $event), (selected.type = 'numero')"
          />
          <multiselect
            v-model="status"
            :options="['Vigente', 'Revogado']"
