			...
			<div class="datatable">
				...
				<div class="flex flex-col items-center justify-center flex-wrap mt-8 gap-8">
					...
					<p class="max-w-3xl text-danger text-sm font-medium text-center">
						A simulação serve somente para você ter noção de como ficará o valor final e o valor de cada parcela a ser paga, <strong>não possui as taxas de juros atualizadas diariamente, o que significa que os dados podem sofrer alterações.</strong>
					</p>
				</div>
			</div>
		</div>
