...
import ConsultaCadastroConsignante from 'src/modules/consultas/components/CadastroConsignante.vue';
	...
	<main>
		<div class="panel mt-6">
			...
			<div class="flex items-center mt-5">
				...
				<span class="flex justify-center badge !w-[80px] h-[22px] bg-success"
					>Ativo</span
				>
			</div>
		</div>
