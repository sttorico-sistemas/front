    ...
    <div class="panel pb-0 mt-6">
      <div class="flex flex-wrap justify-between md:items-center md:flex-row flex-col mb-5 gap-5">
        ...
        <div class="header_actions flex items-center gap-5 ltr:ml-auto rtl:mr-auto">
          ...
          ]" track-by="name" label="label" class="custom-multiselect max-w-[230px]"
            placeholder="Selecione o tipo de margem" :searchable="false" :preselect-first="false" :allow-empty="false"
