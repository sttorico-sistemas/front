...
import ConsultaCadastroConsignante from '../components/CadastroConsignante.vue';
			...
			>
				...
				>
					<multiselect
						...
						:options="['Banco do Brasil S/A', 'ASM']"
						class="custom-multiselect max-w-[230px]"
						placeholder="Consignatária"
						:searchable="false"
					...
					<multiselect
						v-model="instituicao"
						:options="['Instituição Financeira', 'Associação de Classe']"
						class="custom-multiselect max-w-[230px]"
						...
						deselect-label=""
						@select="
							(selected.label = $event), (selected.type = 'tipo_instituicao')
						"
					/>
					<multiselect
						v-model="servico"
