	...
	<main>
		<div class="panel mt-5 border border-primary">
			<label
				...
				class="text-sm md:text-base text-primary m-0 mb-3"
				>Selecione Consignatária</label
			>
			...
			<div class="flex flex-col gap-2.5">
				<div class="flex flex-col md:flex-row items-center mb-3">
					...
					<label
						...
						>Tipo de Entidadse</label
					>
					<select
						id="tipo_entidade"
						class="form-select md:max-w-[270px] h-[38px]"
					>
						<option value=""></option>
				...
				<div class="flex flex-col md:flex-row items-center mb-3">
					...
					<input
						id="cidade"
						type="text"
						class="form-input mb-3 md:mb-0 md:max-w-[250px] h-[38px]"
					/>

					<label
						for="uf"
						class="mb-0 md:mr-4 md:ml-8 w-full md:w-auto text-sm text-left"
						>UF</label
					>
					<input
						id="uf"
						type="text"
						class="form-input mb-3 md:mb-0 md:max-w-[50px] h-[38px]"
					/>
					...
					<input
						id="cep"
						type="text"
						class="form-input mb-3 md:mb-0 md:max-w-[150px] h-[38px]"
					/>
				</div>
				...
				<div class="flex flex-col gap-5 mt-4 mb-10">
					...
					<div class="flex items-center gap-4">
						...
						<label for="cartao_credito" class="mb-0 text-xs"
					...
					<div class="flex items-center gap-4">
						...
						<label for="cartao_beneficio" class="mb-0 text-xs"
							>Cartão de Benefícios</label
						>
					</div>
					<div class="flex items-center gap-4">
					...
					<div class="flex items-center gap-4">
						...
						<label for="financiamentos" class="mb-0 text-xs"
			...
			<div class="flex justify-center items-center gap-12 mt-8">
				...
				<button
					type="button"
					class="w-[86px] btn bg-primary text-white text-xs"
				>
					Salvar
				</button>
			</div>
