...
const post = reactive({
	...
	imagem: 'https://placehold.co/600x375?text=Post+Blog',
	link: '/blog/titulo-do-post',
})
</script>
...
<template>
	<div id="post_blog"
		...
		<div class="resumo bg-cover bg-center bg-no-repeat bg-gray-200/50 p-7"
			...
			<a :href="post.link" class="bg-primary text-white px-3 py-2 rounded-md">
				Saiba mais
			</a>
		</div>
	</div>
