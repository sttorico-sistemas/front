<script lang="ts" setup>
	...
	const properties = defineProps({
		...
		tableSalePointName: { type: String, required: true },
	...
	async function setNewData() {
		...
		try {
			const data =
				await instructionOfProcedureRepository.getInstructionOfProcedureById(
					properties.dataId,
				)
...
<template>
	<form-wrapper
		...
		:title="`Editar averbador ${tableSalePointName}`"
